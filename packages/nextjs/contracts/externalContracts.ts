...
const externalContracts = {
  84532: {
    CHAR: {
      address: "0xf92f74Dd03f9A9E04773cE5fF3BCeaBB2eB1dDf0",
      abi: [
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: "address", name: "tco2", type: "address" }],
        ...
        },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: "address", name: "erc20Addr", type: "address" },
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: "address", name: "feeCalculator", type: "address" }],
          name: "FeeCalculatorUpdated",
          type: "event",
        },
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: "address", name: "filter", type: "address" }],
          name: "FilterUpdated",
          type: "event",
        },
        {
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: "uint256", name: "feeBp", type: "uint256" }],
        ...
        },
        {
          anonymous: false,
          inputs: [
            { indexed: false, internalType: "address", name: "exemptedUser", type: "address" },
            { indexed: false, internalType: "bool", name: "isExempted", type: "bool" },
          ],
        ...
        {
          anonymous: false,
          inputs: [{ indexed: false, internalType: "address", name: "router", type: "address" }],
          name: "RouterUpdated",
          type: "event",
        },
        {
        ...
        },
        {
          ...
          inputs: [
            ...
            { indexed: true, internalType: "address", name: "tco2", type: "address" },
            { indexed: false, internalType: "uint256", name: "amount", type: "uint256" },
          ],
          name: "TCO2Bridged",
          type: "event",
        ...
        },
        {
          ...
          outputs: [{ internalType: "uint256", name: "feeDistributionTotal", type: "uint256" }],
          stateMutability: "view",
          type: "function",
        },
        {
        ...
        },
        {
          inputs: [
            { internalType: "address[]", name: "tco2s", type: "address[]" },
            { internalType: "uint256[]", name: "amounts", type: "uint256[]" },
            { internalType: "bool", name: "toRetire", type: "bool" },
          ],
        ...
        },
        {
          ...
          name: "deposit",
          outputs: [{ internalType: "uint256", name: "mintedPoolTokenAmount", type: "uint256" }],
          stateMutability: "nonpayable",
          type: "function",
        },
        {
        ...
        {
          inputs: [{ internalType: "string", name: "methodology", type: "string" }],
          name: "methodologies",
          outputs: [{ internalType: "bool", name: "", type: "bool" }],
          stateMutability: "view",
          type: "function",
        ...
        },
        {
          ...
          name: "redeemOutMany",
          outputs: [{ internalType: "uint256", name: "poolAmountSpent", type: "uint256" }],
          stateMutability: "nonpayable",
          type: "function",
        },
        {
        ...
        {
          inputs: [{ internalType: "address", name: "_feeCalculator", type: "address" }],
        ...
        {
          inputs: [{ internalType: "address", name: "feeRedeemBurnAddress_", type: "address" }],
        ...
        {
          inputs: [{ internalType: "uint256", name: "feeRedeemBurnPercentageInBase_", type: "uint256" }],
        ...
        {
          inputs: [{ internalType: "address", name: "_filter", type: "address" }],
          name: "setFilter",
          outputs: [],
          stateMutability: "nonpayable",
          type: "function",
        ...
        {
          inputs: [{ internalType: "string", name: "standard", type: "string" }],
          name: "standards",
          outputs: [{ internalType: "bool", name: "", type: "bool" }],
          stateMutability: "view",
          type: "function",
        ...
        {
          inputs: [{ internalType: "address", name: "tco2", type: "address" }],
          name: "tokenBalances",
          outputs: [{ internalType: "uint256", name: "", type: "uint256" }],
          stateMutability: "view",
          type: "function",
